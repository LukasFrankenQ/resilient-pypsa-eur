...
# EU-27 plus UK gas demand in power sector in 2024 (bcm)
# Figure 20 in https://www.oxfordenergy.org/wpcms/wp-content/uploads/2025/07/OIES-Quarterly-Gas-Review-Issue-29.pdf
df_2024_power = pd.Series(
    [13.7, 9.9, 9.8, 6.8, 7.1, 7.5, 9.4, 9., 8.6, 9., 14., 13.1],
    index=["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
    name="power"
)